        ...
        <div className="flex flex-col md:flex-row h-full items-center gap-16">
          ...
          <div className="w-full md:w-1/2 px-6 md:px-10 z-10 space-y-10">
            <div
              ...
              className="flex w-auto items-center gap-3 mb-4 bg-white/90 backdrop-blur-sm px-6 py-3 rounded-full shadow-md hover:shadow-xl transition-all border border-red-100"
            >
            ...
            <h1 className="text-5xl md:text-6xl font-bold leading-tight tracking-tight mt-10">
              <span className="text-red-900 block lg:text-7xl animate-fade-in-down">
                Your
              </span>
              <span className="bg-clip-text text-red-500 bg-gradient-to-r from-red-500 via-rose-500 to-orange-500 block">
                Health is
              </span>
              <span className="text-gray-900 block animate-fade-in-up mb-10">
                Our Priority
              </span>
            </h1>

            <p className="text-gray-700 text-xl leading-relaxed max-w-2xl">
              Experience personalized healthcare through our network of
              qualified professionals. Your well-being is at the heart of
              everything we do.
            </p>
            ...
            <button
              className="px-6 py-3 bg-red-500 text-white mt-16 font-semibold rounded-md text-2xl hover:bg-red-600 transition duration-300"
            >
