...
const About = () => {
  return (
    <div className="flex flex-col md:flex-row items-center md:items-start  py-12 px-6 md:px-16 mb-20 mt-20">
      {/* Left Side - Images */}
      ...
      <div className="w-full md:w-1/2 md:pl-8 text-center md:text-left">
        <h4 className="text-red-500 font-semibold text-sm uppercase mb-2">Welcome to Health Connect</h4>
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
          Best Care For Your Good Health
        </h2>
        <p className="text-gray-600 mb-6">
          At Docmed, we prioritize compassionate, personalized care that meets the unique needs of every patient. 
          Our team of experienced professionals is committed to providing the highest quality medical services, ensuring you receive the best care possible.
        </p>
        
        {/* Checklist */}
        <ul className="space-y-3 mb-6 text-gray-600">
          <li className="flex items-center">
            <FontAwesomeIcon icon={faCheckCircle} className="text-red-500 mr-3" />
